...
/* select ephememeris --------------------------------------------------------*/
extern /*static*/ eph_t* seleph(gtime_t time, int sat, int iode, const nav_t* nav)
{
    double t,tmax,tmin;
    int i,j=-1,sys,sel;
...
extern /*static*/ geph_t* selgeph(gtime_t time, int sat, int iode, const nav_t* nav)
{
...
extern /*static*/ int ephclk(gtime_t time, gtime_t teph, int sat, const nav_t* nav,
                  double *dts)
{
    eph_t  *eph;
    geph_t *geph;
...
extern /*static*/ int ephpos(gtime_t time, gtime_t teph, int sat, const nav_t* nav,
