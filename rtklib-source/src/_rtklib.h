...
//typedef struct {
//    /* Arrays to pass data PosData structure */
//    int ntot;
//    int satIdx[MAXOBS];
//    double taugd[MAXOBS];
//    double range1[MAXOBS];
//    double range2[MAXOBS];
//    double phase1[MAXOBS];
//    double phase2[MAXOBS];
//    double doppler1[MAXOBS];
//    double doppler2[MAXOBS];
//    double elevation[MAXOBS];
//    double azimuth[MAXOBS];
//    double geomDist[MAXOBS];
//    double satpos[MAXOBS][3];
//    double satclk[MAXOBS][2];
//    double rcvclk;
//} export_t;
...
EXPORT int pephpos(gtime_t time, int sat, const nav_t* nav, double* rs,
...
EXPORT eph_t* seleph(gtime_t time, int sat, int iode, const nav_t* nav); // Add declaration to use in pyd module 
EXPORT geph_t* selgeph(gtime_t time, int sat, int iode, const nav_t* nav);
EXPORT int ephclk(gtime_t time, gtime_t teph, int sat, const nav_t* nav, double* dts);
